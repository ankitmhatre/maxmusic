...
public class MaxmusicMediaPlayer extends MediaPlayer {
	...
	/**
	 * Constructs a new MaxmusicMediaPlayer class
	 */
	public MaxmusicMediaPlayer(Context context) {
		super();
		mContext = context;
	}
	...
	public void setNextMediaPlayer(MaxmusicMediaPlayer next) {

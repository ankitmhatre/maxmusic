...
public class MirrorLinkMediaBrowserService extends MediaBrowserService
    ...
    private static final String CUSTOM_ACTION_REPEAT = "com.dragonide.maxmusic.REPEAT";
    // Action to change the repeat mode
    private static final String CUSTOM_ACTION_SHUFFLE = "com.dragonide.maxmusic.SHUFFLE";
    ...
    public void onCreate() {
        Log.d("MaxMusic", "MediaBrowserService#onCreate");
        super.onCreate();
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "com.dragonide.maxmusic/drawable/ic_menu_music_library"))
    ...
    public int onStartCommand(Intent startIntent, int flags, int startId) {
        Log.d("MaxMusic", "MediaBrowserService#onStartCommand");
        return START_STICKY;
    }

    @Override
    public void onDestroy() {
        Log.d("MaxMusic", "MediaBrowserService#onDestroy");
        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... params) {
                ...
                try {
                    ...
                    Log.d("MaxMusic", "Failed retrieving Media");
                }
    ...
    private static final int[] FINISH_ICONS =
            {R.drawable.ic_repeat_off_white_24dp,
                    R.drawable.player_repeat,
                    R.drawable.player_repeat_one,
                    R.drawable.ic_numeric_1_box_white_24dp,
                    R.drawable.ic_dice_5_white_24dp
            };

    private static final int[] SHUFFLE_ICONS =
            {R.drawable.player_shuffle_off
                    , R.drawable.player_shuffle
                    , R.drawable.player_shuffle
                    , R.drawable.ic_album};

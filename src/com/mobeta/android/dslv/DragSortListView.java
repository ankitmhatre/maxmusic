...
import com.dragonide.maxmusic.R;
...
public class DragSortListView extends ListView {
     ...
     *
     * @return The ListAdapter set as the argument of {@link_setAdapter()}
     */
     ...
     * @param position 
     * @param top
     * @param_eight Height of item at position. If -1, this function
    ...
    /**
     * Cancel a drag. Calls {@linkstopDrag(boolean, boolean)} with
     ...
     * items are lifted (see {@linketDragInitMode(int)}).
